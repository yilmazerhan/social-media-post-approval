...
import { getRejectionsReport, toCsv } from "@/modules/reports";
...
/** `?from=&to=&departmentId=&priority=&format=json|csv` — API.md's `/reports/rejections`. */
export const GET = protectedHandler(
  ...
  async ({ request }) => {
    ...
    const rows = await getRejectionsReport({
